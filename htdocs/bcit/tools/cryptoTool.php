 ...
 * more text here
 *
 * @param string $string: string to convert to fixed-length key
 * @param string $length: how long the key should be (i.e. for AES-128 vs. RSA-2048) 
 * @param string $iterations: the number of iterations (https://en.wikipedia.org/wiki/Key_stretching#Strength_and_time)
 *
 * @return string
 */
